...
// (RGB colors have bit 24 set to distinguish them from the ANSI color palette
// colors.) (Isocline will automatically convert from RGB on terminals that do
// not support full colors)
