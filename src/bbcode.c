...
static const style_t builtin_styles[] = {
    ...
    {"em",
     {{IC_COLOR_NONE, IC_ON, IC_NONE, IC_COLOR_NONE, IC_NONE,
       IC_NONE}}},  // bold
    {"url",
     {{IC_COLOR_NONE, IC_NONE, IC_NONE, IC_COLOR_NONE, IC_ON,
       IC_NONE}}},  // underline
    {NULL,
     {{IC_COLOR_NONE, IC_NONE, IC_NONE, IC_COLOR_NONE, IC_NONE, IC_NONE}}}};
    ...
    while (s[i] != 0) {
        ...
        if (s[i] == '[') {
            ...
            if (s[i + 1] == '\\' || s[i + 1] == '[') {
                ...
                attrbuf_append_n(out, attr_out, s + i, 1,
                                 attr);  // pass '\\' as is
                i++;
            }
        }
